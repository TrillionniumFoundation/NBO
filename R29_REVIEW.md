...
Run `python revisions/2026-09-24-r29/replication/test_revision.py`; then `python revisions/2026-09-24-r29/replication/finalize_paper.py`. Compile each of ECTA_R29, SUPP_R29, RESPONSE_R29, COMPUTATION_R29 and HISTORY_R29 with `latexmk -pdf -interaction=nonstopmode -halt-on-error`.
