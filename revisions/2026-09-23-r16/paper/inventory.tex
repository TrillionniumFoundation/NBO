\section{A coupled high-dimensional inventory economy}\label{sec:inventory}
To test full dynamic certification beyond two states, consider a quadratic inventory-adjustment economy. With $M=\mathbf1\mathbf1'/d$,
\begin{equation}
...
\input{revisions/2026-09-23-r16/paper/inventory_table}
