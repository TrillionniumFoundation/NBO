...
ROOT=Path(__file__).resolve().parents[3];REV=ROOT/'revisions/2026-09-24-r28';R=REV/'results';G=REV/'paper/generated'
...
def main():
    ...
    (R/'R28_HEADLINE_RESULTS.json').write_text(json.dumps(digest_summary,indent=2)+'\n')
