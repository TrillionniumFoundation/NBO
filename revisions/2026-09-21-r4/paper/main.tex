...
\label{eq:state}
\end{equation}
Admissibility includes existence of the stopped process and integrability of the stated payoff. For a time-separable payoff, define
\begin{equation}
...
\bottomrule
\end{tabular}
\par\smallskip\footnotesize The budget includes the factor $\theta^2/2$ and time discounting. Exit probabilities refer to this numerical liquidation contract. Nonzero-action shares are date-zero interior lattice shares, not population estimates.
\end{table}
