...
For a scalar interval $[a,b]$ at fixed $k$, write the two endpoint-policy lines as $b_a(s)+d a_a(s)$ and $b_b(s)+d a_b(s)$. Their maximum is a feasible lower envelope. The upper chord minus this maximum is concave and piecewise affine in $d$. Its maximum occurs at an endpoint or at the intersection
\begin{equation}
