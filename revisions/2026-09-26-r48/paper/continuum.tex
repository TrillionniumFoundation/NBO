...
To illustrate decision units fixed before evaluation, assign \$500 to one normalized implementation unit and consider budget levels \$100, \$250, \$500, and \$1,000. The two certified optimal costs are approximately \$634.80 and \$1,434.35. Thus the two-period task has a feasible certified policy below \$1,000 but none below \$500; the three-period task cannot satisfy a \$1,000 implementation budget under the stated operating guarantee. These conclusions are robust to the reported optimization intervals. They are not estimates of market maintenance costs or empirical welfare. The \$500 scale and budget grid are explicit illustrative primitives, and a different scale changes the monetary conclusions mechanically.
