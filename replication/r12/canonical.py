"""Immutable, complete R12 finite-array target. Verification never rebuilds inputs."""
...
def freeze(base,joint,directory):
    ...
    meta=dict(schema='nbo-canonical-v1',spec=dataclasses.asdict(base.spec),models=[vars(e.model) for e in base.e],
              ...
              first_lower=joint.fm.lower,first_upper=joint.fm.upper,source_commit=os.getenv('R12_SOURCE_SHA',os.getenv('GITHUB_SHA','local-development')),
              python=sys.version,numpy=np.__version__,platform=platform.platform(),
              target='new R12 stored arrays, not an asserted bit-identical reconstruction of R11')
